  ...
  <div class="dashboard-wrapper">
    <aside class="sidebar">
      ...
      <nav class="nav-menu">
        ...
        <router-link to="/guru/pengaturan" class="nav-item active"><i class="bi bi-gear-fill"></i><span>Pengaturan</span></router-link>
    ...
    <main class="main-content">
      <header class="topbar">
        <div>
          ...
          <p>Konfigurasi besaran denda dan batas maksimal denda kelas.</p>
        </div>
      </header>
      ...
      <section class="card-box">
        <form @submit.prevent="simpanPengaturan">
          <div class="form-group">
            ...
            <input type="number" v-model.number="dendaPerHari" required class="form-input" />
          </div>
          <div class="form-group">
            <label>Maksimal Denda Keterlambatan (Rp)</label>
            <input type="number" v-model.number="maksDenda" required class="form-input" />
          </div>
          <button type="submit" class="btn-add">Simpan Konfigurasi</button>
        </form>
      </section>
    </main>
  </div>
...
const dendaPerHari = ref(1000)
const maksDenda = ref(10000)

const simpanPengaturan = () => {
  alert('Pengaturan denda berhasil diperbarui!')
}
